...
void fb_init();
void show_bmp(PICINFO *);
void draw_ascii(int , int , int , int , char );
void get_bmpinfo(char *, PICINFO *);
void draw_ico(int ,int ,char *);
void prin_name(int ,int ,char *);
void display(int );
void draw_conten(INFO *);
INFO *create(INFO* ,char *,int );
void show_link(INFO *);
void display_xy(int ,int ,int );
void draw_touch_back(int ,int ,INFO *);
int get_touch(int , VALUE *,INFO *);
int get_touch2(int , VALUE *,INFO *);
void back_pre_dir();
void into_file(char *);
void full_back(int );
int play_mp4(char *,int ,INFO *);
